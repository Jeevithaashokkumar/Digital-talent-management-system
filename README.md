...
1. Database Setup
The system is currently configured to use **SQLite** for zero-dependency local development. No manual database setup (PostgreSQL/Docker) is required for the default configuration.
