...
docker-compose up -d
```
(If you are using a local installation of PostgreSQL, ensure your credentials and database name match the `DATABASE_URL` in the `.env` file).
...
>>>>>>> cb98f6ebabf1d3f1345f5bec473d2d730b99553f
